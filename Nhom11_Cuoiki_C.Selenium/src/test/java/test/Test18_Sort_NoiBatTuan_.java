...
@Test
public class Test18_Sort_NoiBatTuan_
{
    public static void Test3_Sort_NoiBatTuan() {
        int scc = 0;
        ...
        try {
            ...
            Thread.sleep(2000);
            driver.findElement(By.xpath("//div[contains(@class, 'icon_account_gray')]")).click();
            Thread.sleep(2000);
            driver.findElement(By.xpath("//*[@id=\"login_username\"]")).sendKeys("0385859072");
            Thread.sleep(2000);
            driver.findElement(By.xpath("//*[@id=\"login_password\"]")).sendKeys("111111111111111111111111111111");
            Thread.sleep(2000);
            ...
            Thread.sleep(2000);
            driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[2]/div/div/div[2]/div/div/div[2]/div[3]/div[1]/div/div[1]/div/div[2]/div/div/span[4]")).click();
            Thread.sleep(2000);
